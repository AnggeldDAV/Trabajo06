...
namespace Trabajo06.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Index(string currentFilter,
            ...
            int? pageNumber)
        {
            var adventureWorks2016Context = _context.Product;
            var consulta = adventureWorks2016Context.OrderBy(x => x.Name);
            ...
            int pageSize = 100;
            return View(await Paginacion<Product>.CreateAsync(consulta.AsNoTracking(), pageNumber ?? 1, pageSize));
        }
