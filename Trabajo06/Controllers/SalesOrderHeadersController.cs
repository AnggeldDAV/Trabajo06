...
namespace Trabajo06.Controllers
{
    public class SalesOrderHeadersController : Controller
    {
        ...
        public async Task<IActionResult> Index(string currentFilter,
            ...
            int? pageNumber)
        {
            var adventureWorks2016Context = _context.SalesOrderHeader;
            var consulta = adventureWorks2016Context.OrderBy(x => x.SalesOrderId);
            ...
            int pageSize = 100;
            return View(await Paginacion<SalesOrderHeader>.CreateAsync(consulta.AsNoTracking(), pageNumber ?? 1, pageSize));
        }
